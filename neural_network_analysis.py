...
plt.yticks([0.0, 0.1, 0.2], [0.0, 0.1, 0.2], fontsize = 26)
plt.ylabel('')
plt.xlabel('')
...
ftSet = 'UniRep'
titleText = f'{target}/{ftSet} Final Accuracy: {np.round(accFinal,3)}'
EmiAntURX = [-1, -.5, 0, .5, 1, 1.5]
#plt.title(titleText)
plt.xticks(EmiAntURX,EmiAntURX, fontsize = 26)
plt.yticks([0.0, 0.5, 1, 1.5], [0.0, 0.5, 1, 1.5], fontsize = 26)
plt.ylabel('')
plt.xlabel('')
...
plt.scatter(projIggPsyUR.loc[igg_binding['Blosum62'] == 1,0], igg_binding.loc[igg_binding['Blosum62'] == 1,'OVA Binding'], c = cmap(0.15), s = 150, edgecolor = 'k', linewidth = 0.25, zorder = 2)
...
plt.figure()
plt.errorbar(projIggAntPC.loc[igg_binding['Blosum62'] == 1,0], igg_binding.loc[igg_binding['Blosum62'] == 1,'ANT Binding'], yerr = igg_binding.loc[igg_binding['Blosum62'] == 1,'ANT STDEV'], linewidth = 0, elinewidth = 0.25, ecolor = 'k', capsize = 3, zorder = 1)
plt.scatter(projIggAntPC.loc[igg_binding['Blosum62'] == 1,0], igg_binding.loc[igg_binding['Blosum62'] == 1,'ANT Binding'], c = cmap(0.15), s = 150, edgecolor = 'k', linewidth = 0.25, zorder = 2)
plt.scatter(projIggAntPC.iloc[8,0], 1.2, c = 'orange', s = 250, edgecolor = 'k', linewidth = 0.25, zorder = 3)
plt.scatter(projIggAntPC.iloc[41:42,0], 1, color = 'k', s = 250, edgecolor= 'k', linewidth = 0.25, zorder = 3)
# plt.xticks([1, 2, 3,4], [1, 2, 3,4], fontsize = 26)
# plt.yticks([0.0, 0.4, 0.8, 1.2, 1.6], [0.0, 0.4, 0.8, 1.2, 1.6], fontsize = 26)
plt.ylim(-0.05, 1.8)
...
plt.figure()
plt.errorbar(projIggPsyPC.loc[igg_binding['Blosum62'] == 1,0], igg_binding.loc[igg_binding['Blosum62'] == 1,'OVA Binding'], yerr = igg_binding.loc[igg_binding['Blosum62'] == 1,'ANT STDEV'], linewidth = 0, elinewidth = 0.25, ecolor = 'k', capsize = 3, zorder = 1)
plt.scatter(projIggPsyPC.loc[igg_binding['Blosum62'] == 1,0], igg_binding.loc[igg_binding['Blosum62'] == 1,'OVA Binding'], c = cmap(0.15), s = 150, edgecolor = 'k', linewidth = 0.25, zorder = 2)
plt.scatter(projIggPsyPC.iloc[8,0], 0.51, c = 'orange', s = 250, edgecolor = 'k', linewidth = 0.25, zorder = 3)
plt.scatter(projIggPsyPC.iloc[41:42,0], 1, color = 'k', s = 250, edgecolor= 'k', linewidth = 0.25, zorder = 3)
# plt.xticks([1, 2, 3,4], [1, 2, 3,4], fontsize = 26)
# plt.yticks([0.0, 0.4, 0.8, 1.2, 1.6], [0.0, 0.4, 0.8, 1.2, 1.6], fontsize = 26)
plt.ylim(-0.05, 1.8)
...
#%% From Emily's email
#%% Project isolated OHE features and compare w/ data
# Iso correlations, OneHot features
projIsoAntOH = pdAntOH.projector(iso_onehot.values)
...
#%%
#Iso correlations, UniRep features
projIsoAntUR = pdAntUR.projector(iso_reps.values)
...
plt.figure()
plt.scatter(-1*projIsoPsyUR, iso_binding['OVA Binding'].values, c = decIsoPsyUR, cmap = cmap9r, s = 150, edgecolor = 'k', linewidth = 0.25)
plt.scatter(-1*projIsoPsyUR[125], iso_binding.iloc[125,2], c = 'k', s = 250, edgecolor = 'k', linewidth = 0.25)
ovaCorr = sc.stats.spearmanr(projIsoPsyUR, iso_binding['OVA Binding'].values)
corrRho = np.round(ovaCorr.correlation, 2)
corrP = np.ceil(np.log10(ovaCorr.pvalue))
plt.xticks(EmiPsyURX, EmiPsyURX, fontsize = 26)
...
plt.figure()
ovaCorr = sc.stats.spearmanr(projIsoPsyPC, iso_binding['OVA Binding'].values)
plt.scatter(-1*projIsoPsyPC, iso_binding['OVA Binding'].values, c = decIsoPsyPC, cmap = cmap9r, s = 150, edgecolor = 'k', linewidth = 0.25)
